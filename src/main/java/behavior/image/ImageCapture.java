...
public class ImageCapture {
	...
	private boolean useDebugCapture;

	public static final String[] DEVICE = {"QuickTime", "JMF", "Scion FG", "Debug"};

	public boolean useDebugCapture(){
		return useDebugCapture;
	}
	public ImageProcessor getDebugBackIp(){
		if(useDebugCapture){
			return ((DebugCapture)cap).getBackIp().getProcessor();
		}else{
			return null;
		}
	}
