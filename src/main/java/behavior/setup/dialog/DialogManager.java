...
public class DialogManager extends JDialog{
	...
	public DialogManager(Program program, int type, int allCage){
		...
		if(type == Setup.ONLINE && !ImageCapture.getInstance().useDebugCapture())
	...
	public void showAllDialog(){
		...
		if(type == Setup.ONLINE){
			...
			if(!ImageCapture.getInstance().useDebugCapture()){
...
//		}
	...
	public class NextActionListener implements ActionListener{
		public void actionPerformed(ActionEvent e) {
			...
			setButtonLabel();
			if(ImageCapture.getInstance().useDebugCapture()){
				if(currentDialog == parameterDialog){
					backIp = ImageCapture.getInstance().getDebugBackIp();
				}
			}else if(currentDialog == cameraDialog){
