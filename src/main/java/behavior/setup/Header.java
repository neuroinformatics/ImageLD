...
//		case PS:
//		case TS:  return "ID";
//		case HC1: return "ID" +tab+ "Duration(d:h:m:s)" +tab+ "rate = " + Parameter.getInt(Parameter.rate) + "fps" + tab + "Light ON = " + Parameter.getInt(HCParameter.LightON) +"h"+tab+ "Light OFF = "+ Parameter.getInt(HCParameter.LightOFF) + "h";
//		case HC2: return "ID" +tab+ "Duration(d:h:m:s)" +tab+ "rate = " + Parameter.getInt(Parameter.rate) + "fps" + tab +"Light ON = " + Parameter.getInt(HCParameter.LightON) +"h"+tab+ "Light OFF = "+ Parameter.getInt(HCParameter.LightOFF) + "h";
//		case HC3: return "ID" +tab+ "Duration(d:h:m:s)" +tab+ "Mouse Number" +tab+ "rate = " + Parameter.getInt(Parameter.rate) + "fps" + tab + "Light ON = " + Parameter.getInt(HCParameter.LightON) +"h"+tab+ "Light OFF = "+ Parameter.getInt(HCParameter.LightOFF) + "h";
...
//		case TM : return "MouseID" +tab+ "TestType" +tab+ "Latency(sec)" +tab+ "NumberOfChoices" +tab+ "NumberOfChoices_Left" +tab+ "NumberOfChoices_Right" +tab+ "Correct" +tab+ "Error" +tab+ "CorrectPercentage" +tab+ "TotalDistance(cm)";
	...
	public static String getInfoHeader(Program program){
		...
		case HC1: return "SubjectID" +tab+ "Start Time" +tab+ "Elapsed Time(d:h:m:s)" +tab+ "x" +tab+ "y" +tab+ "Current Dist" +tab+ "Changed Area";
		case HC2: return "SubjectID" +tab+ "Start Time" +tab+ "Elapsed Time(d:h:m:s)" +tab+ "X1" +tab+ "Y1" +tab+"X2"+tab+"Y2"+tab+ "Particle"+tab+"Changed Area";
		case HC3: return "SubjectID" +tab+ "Start Time" +tab+ "Elapsed Time(d:h:m:s)" +tab+ "Particle"+tab+"Changed Area";
